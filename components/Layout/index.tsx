...
const Layout = ({ children }: { children: JSX.Element }): ReactElement => {
  ...
  const profile = (
    <Menu>
      <Menu.Item key="/wallet" icon={<CreditCardOutlined rev={undefined} />}>
        <Link href="/wallet" passHref>
          Wallet
        </Link>
      </Menu.Item>
      <Menu.Item key="logout" icon={<LogoutOutlined rev={undefined} />} onClick={handleLogout}>
        Logout
      </Menu.Item>
    </Menu>
  );
        ...
        <header className={styles.header}>
          ...
          >
            <Dropdown className={styles.top} overlay={menu} disabled={!account}>
              ...
              >
                Network <DownOutlined rev={undefined}/>
              </a>
            </Dropdown>
        ...
        {router.pathname !== "/" && (
          <Link href="/" passHref>
            <a className={styles.back}>
              <ArrowLeftOutlined rev={undefined} /> Back Home
            </a>
          </Link>
        )}
